export default function Page() { return ( <div className="min-h-screen bg-gray-50 text-gray-900 font-sans"> {/* Hero Section */} <section className="bg-[#163A5F] text-white px-6 py-20"> <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center"> <div> <h1 className="text-5xl font-bold leading-tight mb-6"> BosTech Solution </h1> <p className="text-xl mb-6 text-gray-200"> Reliable Computer Repairs & IT Support in Benin City. </p> <p className="text-lg text-gray-300 mb-8"> Fast laptop repairs, software installation, networking, CCTV installation, and professional IT support services. </p>
